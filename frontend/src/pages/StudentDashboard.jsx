...
const fetchSubmissions = useCallback(async () => {
  try {
    const res = await axios.get(`https://joineazy-backend.vercel.app/api/submissions/${userId}`);
...
useEffect(() => {
 ...
 const handleSubmitAssignment = async () => {
  ...
  try {
    const res = await axios.post("https://joineazy-backend.vercel.app/api/submissions", {
      studentId: userId,
